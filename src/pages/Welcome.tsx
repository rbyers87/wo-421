      ...
      return (
        <div className="text-center flex flex-col items-center">
          ...
          <p className="text-lg dark:text-gray-300 mb-8">
            Workouts are scored by adding total weight moved and calories together for a total score! /n Create custom workouts from the settings page and set what you want tk be tracked weekly.
          </p>
          {!loading && (
            <img
              src={imageUrl}
